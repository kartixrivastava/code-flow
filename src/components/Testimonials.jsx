                ...
                >
                  <div className="flex items-start space-x-3 sm:space-x-4">
                    <div className="shrink-0 ">
                      <div className="text-2xl sm:text-3xl lg:text-4xl font-bold bg-linear-to-r from-blue-400 to-cyan-300 bg-clip-text text-transparent">
                        "
                      </div>
                    </div>
                    <div className="grow ">
                      ...
                      <div className="flex items-center space-x-2 sm:space-x-3">
                        <img
                          ...
                          className="h-10 w-10 sm:w-12 sm:h-12 rounded-full object-cover"
                        />
                        <div>
