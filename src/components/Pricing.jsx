  ...
  const plans = [
    {
      name: "Starter",
      price: "29.99",
      description: "Perfect for individual and small teams",
      features: [
            ...
            >
              ...
              {plan.mostPopular && (
                <div className="absolute -top-2 sm:-top-3 left-1/2 transform -translate-x-1/2 z-10">
                  <div className="flex items-center space-x-1 px-3 sm:px-4 py-1 smpy-1.5 bg-linear-to-b from-blue-500 to-cyan-500 rounded-full tex-xs sm:text-sm font-semibold shadow-lg">
              ...
              <ul className="space-y-3 sm:space-y-4 mb-6 sm:mb-8 flex-row">
                {plan.features.map((planFeature, featureIdx) => (
                  <li
                    key={featureIdx}
